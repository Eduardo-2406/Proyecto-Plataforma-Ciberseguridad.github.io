  ...
  const moduleData = {
    ...
    quiz: {
      questions: [
        ...
        {
          type: 'fill_blank',
          question: 'El correo electrónico seguro debe usar el protocolo ________ para el cifrado.',
          correctAnswer: 'TLS',
          feedback: 'TLS (Transport Layer Security) es el protocolo estándar para cifrar comunicaciones por correo electrónico.'
        },
        {
          type: 'multiple_choice',
